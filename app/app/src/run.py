...
hair_color_choices = [(hair_color, hair_color[:-5].capitalize()) for hair_color in i2v.hair_color_list]
eye_color_choices = [(eye_color, eye_color[:-5].capitalize()) for eye_color in i2v.eye_color_list]
